DROP DATABASE IF EXISTS `scolar_sys`;
CREATE DATABASE `scolar_sys` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `scolar_sys`;
...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 12 mai 2026 à 15:32
...
CREATE TABLE `action_archive` (
  `id` bigint NOT NULL,
  `action_queue_id` bigint DEFAULT NULL,
  `action_type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payload` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `requested_by` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `executed_by` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `execution_status` enum('success','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'success',
  `execution_message` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `action_confirmations` (
  ...
  `confirmed_by` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `decision` enum('approve','reject') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approve',
...
CREATE TABLE `action_queue` (
  ...
  `payload` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `requested_by` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','approved','rejected','executed','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `emploi_temps` (
  ...
  `classe_id` int NOT NULL,
  `module_id` int NOT NULL,
  `MAT_enseignant` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jour_semaine` enum('Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi','Dimanche') COLLATE utf8mb4_unicode_ci NOT NULL,
  `heure_debut` time NOT NULL,
  `heure_fin` time NOT NULL,
  `salle` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reclamations` (
  `id` int NOT NULL,
  `MAT_etudiant` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sujet` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `traite_par` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('AD-0001', 'Admin', 'Principal', '1990-01-01', 'admin@scolarsys.test', NULL, '$2y$12$yECiXDf7VHlA0kRWNVQMoejsdNbdUAriegjpyzAbH7jnZJbGkylWm', 2, 1, 0, NULL, NULL, NULL, NULL, '2026-04-02 17:29:55', '2026-05-12 13:20:04', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
...
--
-- Alignement final des comptes de test
--
UPDATE `utilisateur`
SET `email` = 'admin@scolarsys.test',
    `motdepasse` = '$2y$12$yECiXDf7VHlA0kRWNVQMoejsdNbdUAriegjpyzAbH7jnZJbGkylWm',
    `role_id` = 2,
    `statut` = 1,
...
UPDATE `utilisateur`
SET `role_id` = 4,
    `motdepasse` = '$2y$10$TcRIRuHIMT7VfDStjufk4OxmRrGpGP8nnVQWrimoLQiwSTAcJG6hq',
    `statut` = 1,
    `must_change_password` = 0,
    `deleted_at` = NULL
WHERE `MAT` = 'GE-0001';
...
SET `role_id` = 3,
    ...
    `must_change_password` = 0,
    `deleted_at` = NULL
WHERE `MAT` IN ('ES-0001', 'ES-0002', 'ES-0003');
...
SET `role_id` = 5,
    ...
    `must_change_password` = 0,
    `deleted_at` = NULL
WHERE `MAT` IN ('ET-0001', 'ET-0002', 'ET-0003');
COMMIT;
