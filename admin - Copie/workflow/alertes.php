    ...
    <div class="alerts-layout">
        ...
        <div class="alerts-main-card">
            <div class="alerts-card-head">
                <div>
                    ...
                    <p>Consultez les evenements importants du systeme.</p>
                </div>
            ...
            <div class="alerts-list">
                ...
                <?php if (count($alerts) === 0): ?>
                    <div class="empty-state">
                        ...
                        <h3>Aucune alerte</h3>
                        <p>Le systeme ne contient aucune alerte pour le moment.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <aside class="alerts-side">
            ...
            <div class="alerts-help-card">
                <h3>Conseil</h3>
                <p>
                    Consultez regulierement les alertes critiques afin de garder le systeme securise et stable.
                </p>
