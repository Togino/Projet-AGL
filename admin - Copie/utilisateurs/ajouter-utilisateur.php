...
$roles = $pdo->query("
    SELECT id, name 
    FROM roles 
    WHERE name IN ('ADMIN', 'GESTIONNAIRE', 'ENSEIGNANT')
    ORDER BY FIELD(name, 'ADMIN', 'GESTIONNAIRE', 'ENSEIGNANT')
")->fetchAll();
$classes = $pdo->query("
...
$success = "";
$temporaryPassword = "";
$allowedPreselectedRoles = ["ADMIN", "GESTIONNAIRE", "ENSEIGNANT"];
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$role_id || !$nom || !$prenom || !$email) {
        ...
        if (!$role) {
            $error = "Role invalide.";
        } elseif (!$isEdit && $role["name"] === "SUPER_ADMIN") {
            $error = "Le role super administrateur ne peut pas etre cree depuis ce formulaire.";
            ...
            try {
                ...
                $stmtLog->execute([
                    $_SESSION["user"]["MAT"],
                    "Creation de l'utilisateur $mat"
                ]);

                $pdo->commit();
                $success = "Utilisateur cree avec succes. Matricule : " . $mat;

                }
            } catch (PDOException $e) {
                $pdo->rollBack();
                $temporaryPassword = "";
                $error = "Erreur lors de la creation. Verifiez l'email ou la base.";
            }
        }
    }
}
...
<section class="dashboard">
    ...
    <?php if ($temporaryPassword): ?>
        <div class="temp-password-box">
            ...
            <small>Transmettez ce mot de passe   l'utilisateur. Il devra obligatoirement le modifier   sa premiere connexion.</small>
        </div>
    <?php endif; ?>
    ...
    <form method="POST" id="createUserForm" class="admin-form">
        ...
        <div class="wizard-layout">
                ...
                <div class="form-grid">
                    ...
                    <div class="full">
                        <div class="info-green small">
                            ...
                            <p>Le systeme generera automatiquement un mot de passe temporaire apres la creation du compte.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="wizard-card step-panel" id="step2">
                <div class="wizard-title">
                    <span>2</span>
                    <h3>Informations specifiques</h3>
                </div>

                <div class="info-green">
                    <i data-lucide="info"></i>
                    <p>Les champs   remplir dependent du role selectionne.</p>
                </div>
                ...
                <div class="specific-box" id="adminBox">
                    ...
                    <div class="permissions-list">
                        <div><i data-lucide="check-circle"></i> Creer des utilisateurs</div>
                        <div><i data-lucide="check-circle"></i> Modifier des utilisateurs</div>
                        <div><i data-lucide="check-circle"></i> Desactiver des comptes</div>
                        <div><i data-lucide="check-circle"></i> Consulter les journaux de securite</div>
                    </div>

                    <div class="info-green small">
                        <i data-lucide="lightbulb"></i>
                        <p>Ce role possede des privileges eleves dans le systeme.</p>
                    </div>
                </div>
                ...
                <div class="specific-box" id="gestionnaireBox">
                    ...
                    <div class="form-grid">
                        <div>
                            ...
                            <select name="service">
                                ...
                                <option>Service scolarite</option>
                                <option>Administration academique</option>
                                <option>Gestion pedagogique</option>
                            </select>
                        </div>
                    ...
                    <div class="info-green small">
                        <i data-lucide="lightbulb"></i>
                        <p>Le gestionnaire s'occupe des operations scolaires quotidiennes.</p>
                    </div>
                </div>
                ...
                <div class="specific-box" id="enseignantBox">
                    ...
                    <div class="info-green small">
                        <i data-lucide="lightbulb"></i>
                        <p>Ces informations aident   mieux gerer les enseignants et leurs affectations.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="wizard-card step-panel" id="step3">
                ...
                <div class="confirm-box">
                    ...
                    <p>Confirmez la creation de cet utilisateur.</p>
                </div>
            ...
            <div class="help-card light">
                ...
                <p>Vous creez un nouvel <?= htmlspecialchars($createdUserLabel) ?>.</p>
                ...
                <div class="role-help">
                    ...
                    <article>
                        ...
                        <small>Acces complet   toutes les fonctionnalites.</small>
                    </article>
                </div>
                ...
                <div class="role-help orange">
                    ...
                    <article>
                        ...
                        <small>Gere les operations quotidiennes.</small>
                    </article>
                </div>
                ...
                <div class="role-help blue">
                    ...
                    <article>
                        ...
                        <small>Enseigne et gere les notes.</small>
                    </article>
                </div>

                <div class="secure-box">
                    <i data-lucide="lock"></i>
                    <span>Les identifiants de connexion seront enregistres de facon securisee.</span>
                </div>
            </div>
        ...
        <div class="wizard-bottom">
            <div class="steps-indicator">
                <div class="step-dot active" data-step="1"><b>1</b> Informations generales</div>
                <span></span>
                <div class="step-dot" data-step="2"><b>2</b> Informations specifiques</div>
                <span></span>
            ...
            <div class="bottom-actions">
                ...
                <button type="submit" class="next-btn hidden" id="submitBtn"><?= $isEdit ? "Enregistrer les modifications" : "Creer " . htmlspecialchars($createdUserLabel === "utilisateur" ? "l'utilisateur" : "le " . $createdUserLabel) ?> <i data-lucide="check"></i></button>
            </div>
        </div>
...
function updateRoleUI() {
    ...
    else if (role === "ADMIN") matPreview.value = "AD-000X";
...
function buildSummary() {
    ...
    ` : "";
    const tel = form.telephone.value || "Non renseigne";
    ...
    confirmSummary.innerHTML = `
        ...
        <div><strong>Telephone :</strong> ${tel}</div>
        ${assignmentSummary}
