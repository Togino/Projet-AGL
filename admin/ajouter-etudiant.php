    ...
    if (!$roleEtudiant) {
        ...
        try {
            ...
            $stmtUser = $pdo->prepare("
                ...
                (MAT, nom, prenom, date_de_naissance, email, motdepasse, role_id, statut, must_change_password, created_by)
                VALUES (?, ?, ?, ?, ?, ?, ?, 1, 1, ?)
            ");
            $stmtUser->execute([
                $mat,
...
<head>
    <meta charset="UTF-8">
    <title>Creer un etudiant - EduManage</title>
    ...
    <section class="dashboard">
        <div class="dashboard-head create-head">
            <div>
                ...
                <p>Accueil <i data-lucide="chevron-right"></i> Etudiants <i data-lucide="chevron-right"></i> Creer un etudiant</p>
            </div>
        ...
        <form method="POST" id="createStudentForm" class="admin-form">
            <div class="wizard-layout">
                ...
                <div class="help-card light">
                    ...
                    <p>Vous creez un nouveau compte etudiant.</p>
            ...
            <div class="wizard-bottom">
                ...
                <div class="bottom-actions">
                    ...
                    <button type="submit" class="next-btn hidden" id="submitBtn">Creer l'etudiant <i data-lucide="check"></i></button>
                </div>
            </div>
        </form>
    </section>
