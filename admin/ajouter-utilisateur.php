...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$role_id || !$nom || !$prenom || !$date_naissance || !$email) {
        ...
        if (!$role) {
            ...
            try {
                ...
                if ($isEdit) {
                    $stmt = $pdo->prepare("
                        UPDATE utilisateur
                        SET nom = ?, prenom = ?, date_de_naissance = ?, email = ?, role_id = ?, statut = ?, updated_by = ?
                        WHERE MAT = ?
                    ");
                    $stmt->execute([
                        $nom,
            ...
            <div class="wizard-card step-panel active" id="step1">
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_de_naissance" value="<?= $isEdit ? htmlspecialchars($editUser["date_de_naissance"]) : "" ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="telephone" placeholder="+223 70 12 34 56">
                    </div>
