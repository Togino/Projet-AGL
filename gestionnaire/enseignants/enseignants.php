                            ...
                            <?php foreach ($enseignants as $index => $enseignant): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="supprimer-enseignant.php?mat=<?= urlencode($enseignant["MAT"]) ?>" class="delete-btn" onclick="return confirm('Envoyer une demande de desactivation pour cet enseignant ?')">Desactiver</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
