        ...
        <div class="settings-main">
            <div class="settings-overview-card">
                ...
                <div class="settings-grid">
                    ...
                    <div class="settings-box orange"><div><i data-lucide="briefcase"></i></div><h3>Role</h3><p><?= htmlspecialchars($account["role"]) ?></p><span><?= htmlspecialchars($account["post"] ?: "Gestionnaire") ?></span></div>
                    <div class="settings-box purple"><div><i data-lucide="activity"></i></div><h3>Statut</h3><p><?= $account["statut"] ? "Actif" : "Inactif" ?></p><span>Espace gestionnaire</span></div>
                </div>
            </div>
        </div>
